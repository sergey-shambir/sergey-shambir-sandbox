...
QString NewClassWidget::namespaceDelimiter() const
{
    return d->m_ui.classLineEdit->namespaceDelimiter();
}

void NewClassWidget::setNamespaceDelimiter(const QString &delim)
{
    d->m_ui.baseClassComboBox->setNamespaceDelimiter(delim);
    d->m_ui.classLineEdit->setNamespaceDelimiter(delim);
}
